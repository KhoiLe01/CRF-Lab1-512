...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{../code/khoi/generated_graphs/mcmc_performance_B10_lr0_001_mom0_2.png}
    \caption{$B=10$, learning rate $=0.001$, momentum $=0.2$}
    \label{fig:4alr1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{../code/khoi/generated_graphs/mcmc_performance_B10_lr0_0003_mom0_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{../code/khoi/generated_graphs/mcmc_performance_B5_lr0_001_mom0_2.png}
    \caption{$B=5$, learning rate $=0.001$, momentum $=0.2$}
    \label{fig:4aB1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{../code/khoi/generated_graphs/mcmc_performance_B20_lr0_001_mom0_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{../code/khoi/generated_graphs/mcmc_performance_B2_lr0_0003_mom0_9.png}
    \caption{$B=2$, learning rate $=0.0003$, momentum $=0.9$}
    \label{fig:4am1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{../code/khoi/generated_graphs/mcmc_performance_B2_lr0_0003_mom0_5.png}
    \caption{$B=2$, learning rate $=0.0003$, momentum $=0.5$}
    \label{fig:4am2}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{../code/khoi/generated_graphs/mcmc_performance_B2_lr0_0003_mom0_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{../code/khoi/generated_graphs/4a_mcmc_performance_B10_lr0_0003_mom0_2.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/LBFGS_S_5.png}
        % \caption{Caption for Image 1}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/LBFGS_S_10.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/LBFGS_S_50.png}
        % \caption{Caption for Image 1}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_2_Objective.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_2_Error.png}
    \end{minipage}
    \caption{$S=2$}
\end{figure}
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_5_Objective.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_5_Error.png}
    \end{minipage}
    \caption{$S=5$}
\end{figure}
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_10_Objective.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_10_Error.png}
    \end{minipage}
    \caption{$S=10$}
\end{figure}
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_50_Objective.png}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_50_Error.png}
    \end{minipage}
    \caption{$S=50$}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_2_Objective_Log.png}
        \caption{log objective for $S=2$}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_5_Objective_Log.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_10_Objective_Log.png}
        \caption{log objective for $S=10$}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../code/khoi/generated_graphs/S_50_Objective_Log.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{../code/khoi/generated_graphs/kl_divergence_comparison.png}
...
\begin{itemize}
	...
	\begin{figure}[H]
	    \centering
	    \includegraphics[width=0.68\linewidth]{../code/angelo/results/q5_letter_accuracy.png}
	...
	\begin{figure}[H]
	    \centering
	    \includegraphics[width=0.68\linewidth]{../code/angelo/results/q5_word_accuracy.png}
