...
\begin{figure}[H]
    ...
    \end{minipage}
\end{figure}
\noindent We observe that there is a steady decrease of both the objective function and word-wise error. However, it takes roughly an hour to get to iteration 10 and 90 evaluations. Thus, we conclude the execution.\\
